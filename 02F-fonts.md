...
\BeginKnitrBlock{rmdnote}<div class="rmdnote">安装 dvisvgm 的命令 `tlmgr install dvisvgm`，安装 ImageMagick 的命令 `sudo apt install imagemagick`</div>\EndKnitrBlock{rmdnote}
