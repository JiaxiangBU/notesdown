...
```{r pdfcrop-map-usa-unemp, fig.cap="pdfcrop 裁剪白边", crop = TRUE,echo=FALSE}
knitr::include_graphics(path = "figures/map_usa_unemp.pdf")
```

```{r pdfcrop-sombrero,fig.cap="去白边", crop = TRUE,echo=FALSE}
knitr::include_graphics(path = "figures/sombrero.pdf")
```
